    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default" href="http://localhost/jfk/web/index.php?r=site%2Fevents">Events &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Donate</h2>
                ...
                <p><a class="btn btn-default" href="http://localhost/jfk/web/index.php?r=site%2Fdonate">Donate &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Shop</h2>
