	 ...
	 <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
				...
				<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
				<input type="hidden" name="cmd" value="_s-xclick">
				<input type="hidden" name="hosted_button_id" value="FQUU7AKPKCUNC">
				<table>
				<tr><td><input type="hidden" name="on0" value="Sky Blue - Size">Sky Blue - Size</td></tr><tr><td><select name="os0">
				<br>
						<option value="Sky Blue - Small">Sky Blue - Small P160.00 PHP</option>
						<option value="Sky Blue - Medium">Sky Blue - Medium P160.00 PHP</option>
						<option value="Sky Blue - Large">Sky Blue - Large P160.00 PHP</option>
				</select> </td></tr>
				</table>
				<br>
				<input type="hidden" name="currency_code" value="PHP">
				...
				<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
				<input type="hidden" name="cmd" value="_s-xclick">
				<input type="hidden" name="hosted_button_id" value="2UG4LRDSHWN3A">
				<table>
				<tr><td><input type="hidden" name="on0" value="Black - Size">Black - Size</td></tr><tr><td><select name="os0">
				<br>	
					<option value="Black - Small">Black - Small P160.00 PHP</option>
					<option value="Black - Medium">Black - Medium P160.00 PHP</option>
					<option value="Black - Large">Black - Large P160.00 PHP</option>
				</select> </td></tr>
				</table>
				<br>
				<input type="hidden" name="currency_code" value="PHP">
