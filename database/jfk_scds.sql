...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2015 at 03:00 PM
...
(20, 'jfk_scds', 'subsciber', 'id', '', '', '_', ''),
(21, 'jfk_scds', 'subsciber', 'first_name', '', '', '_', ''),
(22, 'jfk_scds', 'subsciber', 'last_name', '', '', '_', ''),
(23, 'jfk_scds', 'subsciber', 'subscriber_email', '', '', '_', ''),
(24, 'jfk_scds', 'volunteer', 'id', '', '', '_', ''),
(25, 'jfk_scds', 'volunteer', 'first_name', '', '', '_', ''),
(26, 'jfk_scds', 'volunteer', 'last_name', '', '', '_', ''),
(27, 'jfk_scds', 'volunteer', 'volunteer_email', '', '', '_', ''),
(28, 'jfk_scds', 'volunteer', 'contact_number1', '', '', '_', ''),
(29, 'jfk_scds', 'volunteer', 'contact_number2', '', '', '_', '');
...
('root', '[{"db":"jfk_scds","table":"products"},{"db":"jfk_scds","table":"purchase_details"},{"db":"jfk_scds","table":"volunteer"},{"db":"jfk_scds","table":"event"},{"db":"jfk_scds","table":"subsciber"},{"db":"jfk_scds","table":"user"},{"db":"jfk_scds","table":"donation"},{"db":"jfk","table":"user"},{"db":"jfk","table":"admin"},{"db":"jfk","table":"purchasedetails"}]');
